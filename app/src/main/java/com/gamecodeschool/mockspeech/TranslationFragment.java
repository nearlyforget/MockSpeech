...
public class TranslationFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        translationView = inflater.inflate(R.layout.fragment_translation, container, false);

        //Reference for each widgets
        TextView translation = (TextView) translationView.findViewById(R.id.text_translation);

        //Set speech content to the view.
        translation.setText(speech.getTranslation());
        return translation;
    }
